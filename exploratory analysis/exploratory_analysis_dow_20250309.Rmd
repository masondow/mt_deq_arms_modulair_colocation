...
lt_summary <- lt_data %>%
  summarise(
    ...
    mean_rh_mod = mean(lt_modulair_rh, na.rm = TRUE),
    mean_temp_mod = mean(lt_modulair_tempc, na.rm = TRUE)
  )
...
nc_summary <- nc_data %>%
  summarise(
    ...
    mean_rh_mod = mean(nc_modulair_rh, na.rm = TRUE),
    mean_temp_mod = mean(nc_modulair_tempc, na.rm = TRUE)
  )
...
rp_summary <- rp_data %>%
  summarise(
    ...
    mean_rh_mod = mean(rp_modulair_rh, na.rm = TRUE),
    mean_temp_mod = mean(rp_modulair_tempc, na.rm = TRUE)
  )
